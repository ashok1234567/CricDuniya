...
//    }
    ...
    titles = @[@"LIVE SCORE", @"WHAT NEXT", @"MY PAGE",@"SCHEDULE",@"LEADER BOARD",@"MATCH RESULT",@"INVITE FRIENDS",@"LOG OUT"];
    ...
    self.tblMenuAndNotification.tableHeaderView = ({
        UIView *view = [[UIView alloc] initWithFrame:CGRectMake(20, 0, 0, 50.0f)];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    return cell;
        ...
        if (self.btnResOutlet.selected) {
            ...
            cell.lblMatch.text=[objSharedData getString15FromString:[[objDicResult objectAtIndex:indexPath.row] valueForKey:@"matchtile"]];
